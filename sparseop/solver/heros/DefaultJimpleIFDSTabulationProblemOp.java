 ...
 */
public abstract class DefaultJimpleIFDSTabulationProblemOp<F, D,I extends InterproceduralCFG<Unit,SootMethod>>
  extends DefaultIFDSTabulationProblemOp<Unit,F, D,SootMethod,I> {

	public DefaultJimpleIFDSTabulationProblemOp(I icfg) {
		super(icfg);
	}
