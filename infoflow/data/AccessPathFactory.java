...
public class AccessPathFactory {
	...
	public AccessPath createAccessPath(Unit def, Value val, boolean taintSubFields){
		return createAccessPath(def, val, (SootField[]) null, null, (Type[]) null, taintSubFields,
				false, true, ArrayTaintType.ContentsAndLength);
	}
	
	public AccessPath createAccessPath(Unit def, Value val, Type valType,
			boolean taintSubFields, ArrayTaintType arrayTaintType) {
		return createAccessPath(def, val, null, valType, null, taintSubFields,
				false, true, arrayTaintType);
	}
	
	public AccessPath createAccessPath(Unit def, Value val, SootField[] appendingFields,
			boolean taintSubFields) {
		return createAccessPath(def, val, appendingFields, null, null, taintSubFields,
				false, true, ArrayTaintType.ContentsAndLength);
	}

	public AccessPath createAccessPath(Unit def, Value val, SootField[] appendingFields, Type valType,
									   Type[] appendingFieldTypes, boolean taintSubFields,
									   boolean cutFirstField, boolean reduceBases,
									   ArrayTaintType arrayTaintType) {
		return createAccessPath(def, val, appendingFields, valType, appendingFieldTypes, taintSubFields,
	...
	public AccessPath createAccessPath(Unit def, Value val, SootField[] appendingFields, Type valType,
		...
		return new AccessPath(def, value, fields, baseType, fieldTypes, taintSubFields,
