...
public class AccessPath implements Cloneable {
	...
	AccessPath(Unit defStmt, Local val, SootField[] appendingFields, Type valType,
	...
	public AccessPath copyWithNewValue(Unit def, Value val){
		return copyWithNewValue(def ,val, baseType, false);
	}
	 ...
	 * the val parameter
	 */
	public AccessPath copyWithNewValue(Unit def, Value val, Type newType,
			boolean cutFirstField){
		return copyWithNewValue(def, val, newType, cutFirstField, true);
	}
	...
	public AccessPath copyWithNewValue(Unit def, Value val, Type newType,
		...
		return copyWithNewValue(def, val, newType, cutFirstField,
	 ...
	 * the val parameter
	 */
	public AccessPath copyWithNewValue(Unit def, Value val, Type newType, boolean cutFirstField,
		...
		return AccessPathFactory.v().createAccessPath(def, val, fields, newType,
...
//	}
	...
	public AccessPath clone(){
		...
		AccessPath a = new AccessPath(defStmt , value, fields, baseType, fieldTypes,
	...
	public AccessPath appendFields(SootField[] apFields, Type[] apFieldTypes, boolean taintSubFields) {
		...
		return AccessPathFactory.v().createAccessPath(this.defStmt, this.value, fields, baseType,
	...
	public AccessPath dropFirstField() {
		...
		return AccessPathFactory.v().createAccessPath(this.defStmt, value, newFields, fieldTypes[0],
	...
	public AccessPath dropLastField() {
		...
		return new AccessPath(defStmt, value, newFields, baseType, newTypes,
				taintSubFields, cutOffApproximation, arrayTaintType, canHaveImmutableAliases);
	}
